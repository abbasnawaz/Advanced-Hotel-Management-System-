      ...
      <div class="col-lg-3">
        <div id="box1"><div class="vertical-menu col  ">
          <a href="#" class="active ">DashBoard</a>
              ...
              <a class="nav-link" href="<?php echo e(url('viewRoom')); ?>" target="_blank">Room</a>
              <a class="nav-link" href="<?php echo e(url('viewRoomType')); ?>" target="_blank">Rooms Description</a>              
              <a class="nav-link" href="<?php echo e(url('viewCustomerPhone')); ?>" target="_blank">Customer Phone</a>
...
</html><?php /**PATH E:\web php\marigold\resources\views/dashboard.blade.php ENDPATH**/ ?>