...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css"
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/booknow.css')); ?>">
    ...
    <section class = "section " >
        ...
        <div class="d-flex justify-content-end">
          <div class="d-flex justify-content-end triangle-border">
              <form action="<?php echo e(url('/booknow')); ?>" method = "post">
              <?php echo csrf_field(); ?>
                <div class="row mt-4">
                <div  class="col-6">
...
</html><?php /**PATH E:\web php\marigold\resources\views/booknow.blade.php ENDPATH**/ ?>