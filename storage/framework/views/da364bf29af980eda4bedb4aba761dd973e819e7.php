    ...
    <div class="d-flex justify-content-end triangle-border">
        ...
        <?php echo csrf_field(); ?>
            <div class=" text-center mt-5 p-80" class="col-auto">
                ...
                <br>
                <input type="number"  class="form-control form-back" id="bid" placeholder="Enter Booking ID" required name="R_id" >
            </div>
...
</html><?php /**PATH C:\Users\sb\Desktop\WEB\web php\web php\marigold\resources\views/changestatus.blade.php ENDPATH**/ ?>