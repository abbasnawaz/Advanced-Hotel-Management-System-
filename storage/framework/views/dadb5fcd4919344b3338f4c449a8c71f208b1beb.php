    ...
    <div class="d-flex justify-content-center triangle-border">
        <form action="<?php echo e(url('/registration')); ?>" method="post" >
           ...
           <div class="mb-3 text-center mt-5" class="col-auto">
                <label for="exampleInputEmail1" class="form-label font">Full Name</label>
                <br>
                <input type="text"  class="form-control form-back" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your Full Name"  name ="name">
...
unset($__errorArgs, $__bag); ?></span>
            ...
            <div class="mb-3 text-center mt-5" class="col-auto">
                <label for="exampleInputEmail1" class="form-label font">Password</label>
                <br>
                <input type="password"  class="form-control form-back" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Password"  name = "password">
...
</html><?php /**PATH E:\web php\marigold\resources\views/auth/registration.blade.php ENDPATH**/ ?>