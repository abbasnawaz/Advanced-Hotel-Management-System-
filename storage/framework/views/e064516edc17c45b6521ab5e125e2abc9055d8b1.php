...
<head>
  <title>Special Room Details</title>
...
<body class="back-color">
  ...
  <main>
    <div class="d-flex justify-content-center">
      <div class="d-flex justify-content-center textback">
        <div  class="w-75 p-3 ">
          ...
          <table class="table table-borderless">
            <thead class="thead-dark">
              <tr>
                ...
                <th scope="col">LED</th>
                <th scope="col">Room Refrigerator</th>
                <th scope="col">Cupboard</th>
                <th scope="col">Washroom</th>
                <th scope="col">Working Space</th>
                <th scope="col">Iron</th>
                <th scope="col">Helpline Service</th>
                <th scope="col">Internet</th>
                <th scope="col">Swiming Pool</th>
                <th scope="col">balcony</th>
                <th scope="col">NO. of Bed</th>
                <th scope="col">NO. of Couch</th>
            ...
            <tbody>
              <tr>
                <th scope="row"></th>
                <td>18000/- Per day</td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/x.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
                <td><img src="<?php echo e(asset('img/check.svg')); ?>"></td>
...
<?php /**PATH E:\web php\marigold\resources\views/special.blade.php ENDPATH**/ ?>