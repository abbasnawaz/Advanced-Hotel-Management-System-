    ...
    <div class="d-flex justify-content-center triangle-border">
        <form >
           <div class="mb-3 text-center mt-5" class="col-auto">
                ...
                <br>
                <input type="email"  class="form-control form-back" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your email address" required >
          
            </div>
            <div class="mb-3 text-center mt-5" class="col-auto font">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <br>
                <input type="password"  class="form-control form-back" id="exampleInputPassword1 "  placeholder="Enter your password" required >
            </div>
...
</html><?php /**PATH E:\web php\marigold\resources\views/login.blade.php ENDPATH**/ ?>