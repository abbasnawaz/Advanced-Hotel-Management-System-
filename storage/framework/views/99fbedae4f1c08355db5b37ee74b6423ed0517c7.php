    ...
    <div class = triangle-border>
      <table class="table table-striped table-primary table-borderless table-hover  ">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo e($row->R_id); ?></td>
            <td><?php echo e($row->R_number); ?></td>
            <td><?php echo e($row->floor); ?></td>
            <td><?php echo e($row->R_status); ?></td>
            <td><?php echo e($row->roomtype_id); ?></td>
...
</html><?php /**PATH C:\Users\sb\Desktop\WEB\web php\web php\marigold\resources\views/viewUnBookedRooms.blade.php ENDPATH**/ ?>