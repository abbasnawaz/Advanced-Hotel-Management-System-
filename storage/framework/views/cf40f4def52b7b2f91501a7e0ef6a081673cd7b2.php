...
<body class="back-color font-size">
    ...
    <div class="d-flex justify-content-end triangle-border">
        ...
        <form action = "<?php echo e(url('/changebookingstatus')); ?>" method="post">
...
</html><?php /**PATH C:\Users\sb\Desktop\WEB\web php\web php\marigold\resources\views/changebookingstatus.blade.php ENDPATH**/ ?>