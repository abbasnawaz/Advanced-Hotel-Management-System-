...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/details_room.css')}}">
...
<body class="back-color">
          ...
          <table class="table table-borderless">
            ...
            <tbody>
              <tr>
                <th scope="row"></th>
                <td>5000/- Per day</td>
                <td><img src="{{asset('img/check.svg')}}"></td>
                <td><img src="{{asset('img/check.svg')}}"></td>
                <td><img src="{{asset('img/x.svg')}}"></td>
                <td><img src="{{asset('img/x.svg')}}"></td>
                <td><img src="{{asset('img/check.svg')}}"></td>
                <td><img src="{{asset('img/x.svg')}}"></td>
                <td><img src="{{asset('img/x.svg')}}"></td>
  ...
  <div class="row">
    <div class="col justify-content-center">
      <a type="button" class="btn btn-outline login btn-lg btn-block position btn1" style="color = #E29578 " href="{{route('booknow.page')}}" >BOOK NOW !</a>
