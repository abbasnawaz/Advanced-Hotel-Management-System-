...
<body class="back-color font-size">
    ...
    <div class="d-flex justify-content-center triangle-border">
        ...
        <form action = "{{url('/addroomid')}}" method="post">
        @csrf
            <div class=" text-center mt-5 p-80" class="col-auto">
                ...
                <input type="number"  class="form-control form-back" id="bid" placeholder={{Session('booking_id')}} value = {{Session('booking_id')}} required  name = "booking_id" >
                @endif
            </div>
